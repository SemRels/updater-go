...
# SPDX-FileCopyrightText: 2026 The updater-go Authors
...
LABEL org.opencontainers.image.title="semrel-plugin-updater-go" \
      org.opencontainers.image.description="semrel plugin: update Go version variables on release" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/updater-go" \
