...
import (
	...
	grpcserver "github.com/SemRels/updater-go/internal/grpc"
	semrelplugin "github.com/SemRels/updater-go/internal/plugin"
)

func main() {
	provider := semrelplugin.NewProvider("updater-go")
